    ...
    return (
      ...
      <div className="sidenav-header">
        ...
        <a className="navbar-brand m-0" href="/" target="_blank">
          ...
          <span className="ms-1 font-weight-bold">Stock App Dashboard</span>
        </a>
      </div>
        ...
        <ul className="navbar-nav">
          <li className="nav-item">
            <a className="nav-link  active" href="#">
              ...
              <span className="nav-link-text ms-1">{this.state.menu0}</span>
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link  " href="/profile">
              ...
              <span className="nav-link-text ms-1">{this.state.menu1}</span>
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link  " href="../pages/billing.html">
              ...
              <span className="nav-link-text ms-1">{this.state.menu2}</span>
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link  " href="../pages/virtual-reality.html">
              ...
              <span className="nav-link-text ms-1">{this.state.menu3}</span>
            </a>
          </li>
          <li className="nav-item">
          ...
          <li className="nav-item mt-3">
            <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">{this.state.menu4}</h6>
          </li>
          <li className="nav-item">
            <a className="nav-link  " href="../pages/profile.html">
              ...
              <span className="nav-link-text ms-1">{this.state.menu5}</span>
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link " type="button" onClick={this.onLogout}>
              ...
              <span className="nav-link-text ms-1">{this.state.menu6}</span>
            </a>
          </li>
        </ul>
      </div>
